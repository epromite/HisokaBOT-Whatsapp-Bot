...
Untuk menggunakan bot silahkan kirim ${prefix}menu`)
	...
	case "revoke":
        ...
        if (!isGroupMsg) return dxxoo.reply(from, menuId.textPrem(), id)
            ...
            await dxxoo.reply(from, fmlx, id)
            .catch(() => {
                dxxoo.reply(from, 'Hayolohhh, ada yang error!!', id)
            })
            break
        ...
        if (!isGroupMsg) return dxxoo.reply(from, menuId.textPrem(), id)
            ...
            await dxxoo.sendFileFromUrl(from, memeindox, 'memeindo.jpeg', 'Nih.....', id)
            .catch(() => {
                dxxoo.reply(from, 'Hayolohhh, ada yang error!!', id)
            })
            break
        ...
        if (!isGroupMsg) return dxxoo.reply(from, menuId.textPrem(), id)
            ...
            await dxxoo.sendFileFromUrl(from, darkjokesx, 'memeindo.jpeg', 'Nih.....', id)
            .catch(() => {
                dxxoo.reply(from, 'Hayolohhh, ada yang error!!', id)
            })
            break
