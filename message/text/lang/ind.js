...
exports.ownerOnly = () => {
    return `Command ini khusus Onwer Bot!`
}

exports.doneOwner = () => {
    return `Sudah selesai, Lord!`
}
...
exports.botNotPremium = () => {
    return `Bot ini tidak mendukung command premium. Silakan hubungi owner bot.`
}
...
Bot ini merupakan open-source bot dengan nama asli HisokaBot yang tersedia di GitHub secara gratis.
...
https://github.com/dxxoo/HisokaBOT-Whatsapp-Bot
